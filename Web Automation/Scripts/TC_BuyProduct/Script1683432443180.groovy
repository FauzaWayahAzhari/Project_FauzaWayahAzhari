...
WebUI.setText(findTestObject('Object Repository/Buy Product/Page_frontend-web/input_Email_input-18'), 'test@gmail.com')

WebUI.setText(findTestObject('Object Repository/Buy Product/Page_frontend-web/input_Password_input-21'), 'test')

WebUI.click(findTestObject('Object Repository/Buy Product/Page_frontend-web/button_Login'))
