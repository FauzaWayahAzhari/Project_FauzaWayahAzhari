...
WebUI.setText(findTestObject('Object Repository/Login/Page_frontend-web/input_Email_input-18'), 'test@gmail.com')

WebUI.setText(findTestObject('Object Repository/Login/Page_frontend-web/input_Password_input-21'), 'test')
